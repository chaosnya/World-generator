 ...
 * @author Connor
 */
class TestGraphImpl(v: Voronoi, numLloydRelaxations: Int, r: Random) : VoronoiGraph(v, numLloydRelaxations, r) {
    ...
    override fun getColor(biome: Enum<*>): Color {
        return (biome as ColorData).color
    }

    override fun getBiome(p: Center): Enum<*> {
        if (p.ocean) {
